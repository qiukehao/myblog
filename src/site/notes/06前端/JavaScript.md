...
1. **ECMAScript**
   ...
   ![](https://qkh-markdown-1316031240.cos.ap-nanjing.myqcloud.com/obsidian/202301101140323.png)
...
#### 8.4.1 转换为字符串
  ...
  ![](https://qkh-markdown-1316031240.cos.ap-nanjing.myqcloud.com/obsidian/202301101140432.png)
...
![](https://qkh-markdown-1316031240.cos.ap-nanjing.myqcloud.com/obsidian/202301111703888.png)
...
现实生活中︰万物皆对象，**对象是一个具体的事物**，看得见摸得着的实物。例如，一本书、一辆汽车、**一个人可以是“对象”,也可以不是对象,看你的指定是不是具体的**，一个数据库、一张网页、一个与远程服务器的连接也可以是“对象”。
...
1. 请使用arguments完成函数getResult，实现得到输入的所有的数值中的最小值、最大值、平均数、总和等功能
...
![image.png](https://qkh-markdown-1316031240.cos.ap-nanjing.myqcloud.com/obsidian/202301141210084.png)
...
- 数组中有进行增加、删除元素的方法，部分方法如下表
  ...
  ![](https://qkh-markdown-1316031240.cos.ap-nanjing.myqcloud.com/obsidian/202301132143027.png)
...
- 数组中有对数组本身排序的方法，部分方法如下表
  ...
  ![](https://qkh-markdown-1316031240.cos.ap-nanjing.myqcloud.com/obsidian/202301132143051.png)
...
```js
arr
(8) [1, 2, 3, 4, 7, 32, 12, 45]
arr.sort()
(8) [1, 12, 2, 3, 32, 4, 45, 7]
//排序异常,这是因为,它是比较了各个数字的第一个字母的大小,而不是比较整体的大小
```
==解决办法==
```js
//升序排列
...
(8) [1, 2, 3, 4, 7, 12, 32, 45]
//降序排列
arr.sort(function(a,b){
    return b-a;
})
(8) [45, 32, 12, 7, 4, 3, 2, 1]
```
...
- 数组中有获取数组指定元素索引值的方法，部分方法如下表
  ...
  ![](https://qkh-markdown-1316031240.cos.ap-nanjing.myqcloud.com/obsidian/202301132143070.png)


==indexof从前面找,碰到重复的取第一个==
```js
(8) [45, 32, 12, 7, 4, 3, 2, 1]
arr.indexOf(32)
1
如果有重复的就是找到的第一个,如果没有找到元素,那么返回的就是-1
```

==lastindexof(),从后面找,碰到重复的找最后一个==
```js
(8) [45, 32, 12, 7, 4, 3, 2, 1]
arr.indexOf(32)
1
...
- 数组中有把数组转化为字符串的方法，部分方法如下表
  ...
  ![](https://qkh-markdown-1316031240.cos.ap-nanjing.myqcloud.com/obsidian/202301132143088.png)
...
- 数组中还有其他操作方法，同学们可以在课下自行查阅学习
  ...
  ![](https://qkh-markdown-1316031240.cos.ap-nanjing.myqcloud.com/obsidian/202301132143107.png)
...
![](https://qkh-markdown-1316031240.cos.ap-nanjing.myqcloud.com/obsidian/202301132143126.png)
...
![](https://qkh-markdown-1316031240.cos.ap-nanjing.myqcloud.com/obsidian/202301132143147.png)
...
![](https://qkh-markdown-1316031240.cos.ap-nanjing.myqcloud.com/obsidian/202301132143167.png)
...
![](https://qkh-markdown-1316031240.cos.ap-nanjing.myqcloud.com/obsidian/202301132143188.png)

> 拼接字符串

concat(str,str1....)这个我们不常用,我们一般用+号
...
null是一个空对象,它的类型是object这是一个错误,但是知错就错了,就没改
...
![](https://qkh-markdown-1316031240.cos.ap-nanjing.myqcloud.com/obsidian/202301132143210.png)

> 简单数据类型的存储方式

  ​		值类型变量的数据直接存放在变量（栈空间）中

![](https://qkh-markdown-1316031240.cos.ap-nanjing.myqcloud.com/obsidian/202301132143231.png)

> 复杂数据类型的存储方式

  ​		引用类型变量（栈空间）里存放的是地址，真正的对象实例存放在堆空间中

我们在栈空间里存放一个指向堆里面的空间的一个地址
![image.png](https://qkh-markdown-1316031240.cos.ap-nanjing.myqcloud.com/obsidian/202301142249647.png)
...
![](https://qkh-markdown-1316031240.cos.ap-nanjing.myqcloud.com/obsidian/202301132143253.png)

>对于数字型的类型,我们是可以改变的,但是对于字符型的它的空间是不变的
...
![](https://qkh-markdown-1316031240.cos.ap-nanjing.myqcloud.com/obsidian/202301132143276.png)
...
<script>
	function getDayNum(time){
		...
		var str = year + '-' +'1' + '-' +'1';  //当前年的第一天
		//我们需要获得当前年的第一天的时间戳
		var nowtime = +new Date(str);
		var second = (inputtime - nowtime)/1000;
		var day = parseInt(second / 60 / 60 / 24);
		day = day < 10 ? '0' + day : day;
		console.log('距离这一年的第一天有' + day + '天');
	}
	var time = prompt('请输入时间');
	getDayNum(time);
</script>
